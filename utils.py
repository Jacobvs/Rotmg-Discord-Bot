...
#                    ("<:warrior:682204616997208084>", 2),
#                    ("<:paladin:682205688033968141>", 2),
#                    ("<:trickster:682214467483861023>", 2),
#                    ("<:mystic:682205700918607969>", 2),
#                    ("<:assassin:734133157951045734>", 1),
#                    ("<:Bard:735022210657550367>", 1),
...
#                            "<:shieldrune:737672554642276423>", "<:helmrune:737673058722250782>",
#                            "<:warrior:682204616997208084>",
...
#                 discord.Color.from_rgb(231, 76, 60), "https://i.imgur.com/nPkovWR.png"),
...
#             10: ("Tomb", ["<:TomboftheAncientsPortal:561248700723363860>", "<:tombOfTheAncientsKey:561248916822163487>", "<:warrior:682204616997208084>",
#                           "<:paladin:682205688033968141>", "<:priest:682206578908069905>"],
#                  ["<:knight:682205672116584459>", "<:mystic:682205700918607969>", "<:Bard:735022210657550367>", "<:armorbreak:682206598156124212>",
#                   "<:paralyze:764276970283466752>"],
#                  ["<:planewalker:682212363889279091>"],
...
#             51: ("High Tech Terror", ["<:HTTPortal:767916937896001557>", "<:HTTKey:767914572551815179>"],
#                  ["<:fg_tome:695211244033933332>", "<:armorbreak:682206598156124212>", "<:Bard:735022210657550367>", "<:trickster:682214467483861023>"],
#                  [],
#                  discord.Color.from_rgb(50, 30, 138), "https://i.imgur.com/EG1ROM8.png"),
#             52: ("Heroic UDL", ["<:HUDL:711479365602508820>", "<:hudlKey:711444346334871643>"],
#                  [],
#                  [],
#                  discord.Color.from_rgb(254, 196, 54), "https://i.imgur.com/WmL1qda.png"),
#             53: ("Heroic Abyss", ["<:HAbyss:711431861678637129>", "<:habbyKey:711444346263830559>"],
#                  [],
#                  [],
#                  discord.Color.from_rgb(254, 196, 54), "https://i.imgur.com/LCALe5V.png"),
#             54: ("Janus", ["<:Janus:727609287148306552>", '<:WineCellarInc:708191799750950962>', "<:trickster:682214467483861023>",
...
#             55: ("Oryx 2", ["<:O2:727610126592376873>", '<:WineCellarInc:708191799750950962>', "<:trickster:682214467483861023>",
#                            "<:ninja_3:585616162151202817>", "<:warrior:682204616997208084>", "<:knight:682205672116584459>",
#                            "<:paladin:682205688033968141>", "<:priest:682206578908069905>"],
#                  [],
#                  ["<:planewalker:682212363889279091>"],
#                  discord.Color.from_rgb(0, 0, 0), "https://static.drips.pw/rotmg/wiki/Enemies/Oryx%20the%20Mad%20God%202.png"),
#             56: ("Keyper Clearing", ["<:whitebag:682208350481547267>", '<:WineCellarInc:708191799750950962>',
...
def dungeon_info(num: int = None):
    with open('data/dungeons.json') as f:
        dungeons = json.load(f, object_hook=keystoint)
    if not num:
        del dungeons[-1]
        del dungeons[-2]
        del dungeons[0]
